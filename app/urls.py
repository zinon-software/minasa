...
urlpatterns = [
    ...
    path('teacher/<int:teacher_id>/students/<int:room_id>', views.students, name='students'),
    path('teacher/<int:teacher_id>/students/<int:room_id>/students/<int:students_id>', views.solutions, name='solutions'),
